...
{
	std::cout <<"start render triangle"<< std::endl;
	...
	std::cout <<"render triangle 1"<< std::endl;
	context.params.output_file_name = image_prefix + output_name;
	std::cout <<"render triangle 1.1"<< std::endl;
	std::shared_ptr<Scene> scene = std::make_shared<TriangleScene>(context.params);
	std::cout <<"render triangle 1.2"<< std::endl;
	context.add_scene(scene);
	std::cout <<"render triangle 2"<< std::endl;
	HostRender::run(context, render_pixel);
	std::cout <<"ende render triangle"<< std::endl;
}
